 ...
 *
 * <p>We have chosen to map events to instance methods to allow for better test coverage
 * computation.
 *
 * <p>Mapping events to static methods might have also worked but that would have resulted in
 * uncovered default constructors.
 */
